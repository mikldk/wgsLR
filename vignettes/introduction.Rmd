...
The last lines estimate the standard error that will be used below to construct approximate confidence intervals.
...
abline(v = w_b_q[1], col = "deeppink3", lty = "dashed")
abline(v = w_b_q[2], col = "deeppink3", lty = "dashed")
abline(v = w_mle, col = "yellow3", lwd = 3)
abline(v = w_mle - 2*w_mle_se, col = "yellow3", lty = "dashed")
abline(v = w_mle + 2*w_mle_se, col = "yellow3", lty = "dashed")
